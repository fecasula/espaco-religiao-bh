#=======================================================
# TESTE MODELOS LOGÍSTIVOS (DEMOGRAFICO, SOCIODEMO., GERAL) PARA RMBH
#=======================================================
# OBJETIVO:
...
base_regressao_bh <- read.csv(paste0(base_path, '/dados/tratados/base_rmbh_regressao.csv'))
...
modelsummary(
  ...
  title = "Regressão Logística para População Residente na RMBH: Razão de Chance (OR), 95% IC",
  notes = c(
